...
const ssbuRouter = require('./Routers/ssbu');

app.use('/api/usuarios', usuariosRouter);
app.use('/api/productos', productosRouter);
app.use('/api/compras', comprasRouter);
app.use('/api/ssbu', ssbuRouter);
...
ssbu : {
    personajes : {
        listar : 'GET /api/ssbu/personajes',
        obtener : 'GET /api/ssbu/personajes/:id',
        crear : 'POST /api/ssbu/personajes',
        actualizar : 'PUT /api/ssbu/personajes/:id',
        eliminar : 'DELETE /api/ssbu/personajes/:id'
    }
}
